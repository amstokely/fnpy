...
contains
    ...
    !
    ! Arguments:
    ! - this: The instance of c_string_t being operated on.
    ...
    function to_c(this, f_string) result(c_string)
        class(c_string_t), target, intent(inout) :: this
    ...
    function to_f(this, c_string) result(f_string)
        class(c_string_t), intent(inout) :: this
    ...
    ! null-terminated string when the instance of c_string_t goes out of scope
    ! or is explicitly deallocated.
    !
    ! Arguments:
    ! - this: The instance of c_string_t being finalized.
    subroutine cleanup(this)
        type(c_string_t), intent(inout) :: this
        if (allocated(this%fc_string)) then
            deallocate(this%fc_string)
        end if
    end subroutine cleanup

end module c_string_t_mod
